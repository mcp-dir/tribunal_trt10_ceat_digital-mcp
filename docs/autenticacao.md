...
Tribunal TRT10: Certidão Eletrônica de Ações Trabalhistas (CEAT) - Processos Digitais usa um único endpoint público (`https://api.mcp.ai/p_tribunal_trt10_ceat_digital`).
